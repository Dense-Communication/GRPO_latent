...
#SBATCH --job-name=train_v4_winogrande_k30
#SBATCH --output=logs/train_v4_winogrande_topk30_%j.out
#SBATCH --error=logs/train_v4_winogrande_topk30_%j.err

# V4: Pure task optimization - find optimal accuracy-efficiency trade-off
# winogrande with top_k=30
...
TRAIN_SPLIT = "train"
TRAIN_SAMPLES = 500
CHECKPOINT_PATH = "checkpoints/ablation_v4/winogrande_topk30_policy.pt"
