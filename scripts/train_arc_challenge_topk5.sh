...
#SBATCH --job-name=train_arc_challenge_k5
#SBATCH --output=logs/train_arc_challenge_topk5_%j.out
#SBATCH --error=logs/train_arc_challenge_topk5_%j.err
...
TRAIN_SPLIT = "train"
TRAIN_SAMPLES = 300
CHECKPOINT_PATH = "checkpoints/ablation/arc_challenge_topk5_policy.pt"
