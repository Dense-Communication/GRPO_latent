...
#SBATCH --job-name=train_v3_winogrande_k5
#SBATCH --output=logs/train_v3_winogrande_topk5_%j.out
#SBATCH --error=logs/train_v3_winogrande_topk5_%j.err

# V3: Focus on accuracy - smaller cost penalty, larger task reward
# winogrande with top_k=5
...
TRAIN_SPLIT = "train"
TRAIN_SAMPLES = 500
CHECKPOINT_PATH = "checkpoints/ablation_v3/winogrande_topk5_policy.pt"
