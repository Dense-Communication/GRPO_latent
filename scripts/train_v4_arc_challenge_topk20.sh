...
#SBATCH --job-name=train_v4_arc_challenge_k20
#SBATCH --output=logs/train_v4_arc_challenge_topk20_%j.out
#SBATCH --error=logs/train_v4_arc_challenge_topk20_%j.err

# V4: Pure task optimization - find optimal accuracy-efficiency trade-off
# arc_challenge with top_k=20
...
TRAIN_SPLIT = "train"
TRAIN_SAMPLES = 500
CHECKPOINT_PATH = "checkpoints/ablation_v4/arc_challenge_topk20_policy.pt"
