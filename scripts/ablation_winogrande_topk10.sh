...
#SBATCH --job-name=ablation_winogrande_topk10
#SBATCH --output=logs/ablation_winogrande_topk10_%j.out
#SBATCH --error=logs/ablation_winogrande_topk10_%j.err

# Top-K Ablation: winogrande with top_k=10
