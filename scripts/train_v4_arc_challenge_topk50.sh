...
#SBATCH --job-name=train_v4_arc_challenge_k50
#SBATCH --output=logs/train_v4_arc_challenge_topk50_%j.out
#SBATCH --error=logs/train_v4_arc_challenge_topk50_%j.err
...
TRAIN_SPLIT = "train"
TRAIN_SAMPLES = 500
CHECKPOINT_PATH = "checkpoints/ablation_v4/arc_challenge_topk50_policy.pt"
