...
#SBATCH --job-name=test_qwen3_8b_arc_challenge
#SBATCH --output=logs/test_qwen3_8b_arc_challenge_%j.out
#SBATCH --error=logs/test_qwen3_8b_arc_challenge_%j.err

# Evaluate TRAINED policy on TEST split: Qwen3-8B on arc_challenge
...
TASK = "arc_challenge"
N_SAMPLES = 500
POLICY_CHECKPOINT = "/p/scratch/westai0052/liu52/LatentMAS/checkpoints/rl_policy/qwen3_8b_arc_challenge_14508793/policy_best.pt"
DATA_SPLIT = "test"
