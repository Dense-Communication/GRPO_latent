...
#SBATCH --job-name=test_qwen3_14b_winogrande
#SBATCH --output=logs/test_qwen3_14b_winogrande_%j.out
#SBATCH --error=logs/test_qwen3_14b_winogrande_%j.err

# Evaluate TRAINED policy on TEST split: Qwen3-14B on winogrande
...
TASK = "winogrande"
N_SAMPLES = 500
POLICY_CHECKPOINT = "/p/scratch/westai0052/liu52/LatentMAS/checkpoints/rl_policy/qwen3_14b_winogrande_14508797/policy_best.pt"
