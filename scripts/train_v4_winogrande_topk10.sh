...
#SBATCH --job-name=train_v4_winogrande_k10
#SBATCH --output=logs/train_v4_winogrande_topk10_%j.out
#SBATCH --error=logs/train_v4_winogrande_topk10_%j.err
...
TRAIN_SPLIT = "train"
TRAIN_SAMPLES = 500
CHECKPOINT_PATH = "checkpoints/ablation_v4/winogrande_topk10_policy.pt"
