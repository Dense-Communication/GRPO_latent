...
#SBATCH --job-name=train_v3_arc_challenge_k10
#SBATCH --output=logs/train_v3_arc_challenge_topk10_%j.out
#SBATCH --error=logs/train_v3_arc_challenge_topk10_%j.err

# V3: Focus on accuracy - smaller cost penalty, larger task reward
# arc_challenge with top_k=10
...
TRAIN_SPLIT = "train"
TRAIN_SAMPLES = 500
CHECKPOINT_PATH = "checkpoints/ablation_v3/arc_challenge_topk10_policy.pt"

# Hyperparameters focused on accuracy
LR = 1e-05
KL_COEF = 0.0
ENTROPY_COEF = 0.01
ALPHA = 2.0  # Task reward weight
BETA = 0.3    # Consistency weight
GAMMA = 0.02  # Cost penalty (small!)
NUM_EPOCHS = 5
