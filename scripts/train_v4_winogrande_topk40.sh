...
#SBATCH --job-name=train_v4_winogrande_k40
#SBATCH --output=logs/train_v4_winogrande_topk40_%j.out
#SBATCH --error=logs/train_v4_winogrande_topk40_%j.err
...
TRAIN_SPLIT = "train"
TRAIN_SAMPLES = 500
CHECKPOINT_PATH = "checkpoints/ablation_v4/winogrande_topk40_policy.pt"
