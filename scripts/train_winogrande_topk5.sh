...
#SBATCH --job-name=train_winogrande_k5
#SBATCH --output=logs/train_winogrande_topk5_%j.out
#SBATCH --error=logs/train_winogrande_topk5_%j.err
...
TRAIN_SPLIT = "train"
TRAIN_SAMPLES = 300
CHECKPOINT_PATH = "checkpoints/ablation/winogrande_topk5_policy.pt"
