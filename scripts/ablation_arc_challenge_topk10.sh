...
#SBATCH --job-name=ablation_arc_challenge_topk10
#SBATCH --output=logs/ablation_arc_challenge_topk10_%j.out
#SBATCH --error=logs/ablation_arc_challenge_topk10_%j.err

# Top-K Ablation: arc_challenge with top_k=10
