...
# 交互式节点本地运行脚本 - 完整版训练
#
# 使用方法 (在已经 salloc 登录的节点上):
#   cd /p/scratch/westai0052/liu52/LatentMAS
#   bash scripts/run_local.sh [TASK]
#
# 支持的数据集:
#   gsm8k        - 数学推理 (默认)
#   arc_easy     - ARC Easy 科学问答
#   arc_challenge- ARC Challenge 科学问答 (更难)
#   gpqa         - GPQA Diamond 研究生级别问答
#   aime2024     - AIME 2024 数学竞赛
#   aime2025     - AIME 2025 数学竞赛
#   mbppplus     - MBPP+ 代码生成
#   humanevalplus- HumanEval+ 代码生成
#   medqa        - MedQA 医学问答
#
# 示例:
#   bash scripts/run_local.sh gsm8k
#   bash scripts/run_local.sh arc_challenge
#   bash scripts/run_local.sh gpqa
# ============================================================
...
echo "=========================================="
echo "RL Training - Full Training Run"
echo "Node: $(hostname)"
echo "Task: $TASK"
