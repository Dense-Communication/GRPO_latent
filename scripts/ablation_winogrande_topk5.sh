...
#SBATCH --job-name=ablation_winogrande_topk5
#SBATCH --output=logs/ablation_winogrande_topk5_%j.out
#SBATCH --error=logs/ablation_winogrande_topk5_%j.err

# Top-K Ablation: winogrande with top_k=5
