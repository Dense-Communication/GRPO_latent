...
#SBATCH --job-name=train_8b_arc_challenge_k40
#SBATCH --output=logs/train_v4_8b_arc_challenge_topk40_%j.out
#SBATCH --error=logs/train_v4_8b_arc_challenge_topk40_%j.err

# V4 8B: Qwen3-8B evaluation
# arc_challenge with top_k=40
...
TRAIN_SPLIT = "train"
TRAIN_SAMPLES = 500
CHECKPOINT_PATH = "checkpoints/ablation_v4_8b/arc_challenge_topk40_policy.pt"
