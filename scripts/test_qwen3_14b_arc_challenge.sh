...
#SBATCH --job-name=test_qwen3_14b_arc_challenge
#SBATCH --output=logs/test_qwen3_14b_arc_challenge_%j.out
#SBATCH --error=logs/test_qwen3_14b_arc_challenge_%j.err

# Evaluate TRAINED policy on TEST split: Qwen3-14B on arc_challenge
...
TASK = "arc_challenge"
N_SAMPLES = 500
POLICY_CHECKPOINT = "/p/scratch/westai0052/liu52/LatentMAS/checkpoints/rl_policy/qwen3_14b_arc_challenge_14508796/policy_best.pt"
DATA_SPLIT = "test"
...
data = list(load_arc_challenge(split=DATA_SPLIT))[:N_SAMPLES]
