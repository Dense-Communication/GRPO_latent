...
#SBATCH --job-name=train_qwen3_14b_winogrande
#SBATCH --output=logs/train_qwen3_14b_winogrande_%j.out
#SBATCH --error=logs/train_qwen3_14b_winogrande_%j.err

# Train reading policy: Qwen3-14B on winogrande
...
python3 run_rl_train.py \
    ...
    --max_grad_norm 1.0 \
    --seed 42 \
    --output_dir checkpoints/rl_policy/qwen3_14b_winogrande_$SLURM_JOB_ID
