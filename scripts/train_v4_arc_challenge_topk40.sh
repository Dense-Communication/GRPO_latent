...
#SBATCH --job-name=train_v4_arc_challenge_k40
#SBATCH --output=logs/train_v4_arc_challenge_topk40_%j.out
#SBATCH --error=logs/train_v4_arc_challenge_topk40_%j.err
...
TRAIN_SPLIT = "train"
TRAIN_SAMPLES = 500
CHECKPOINT_PATH = "checkpoints/ablation_v4/arc_challenge_topk40_policy.pt"
