...
#SBATCH --job-name=train_8b_winogrande_k50
#SBATCH --output=logs/train_v4_8b_winogrande_topk50_%j.out
#SBATCH --error=logs/train_v4_8b_winogrande_topk50_%j.err
...
TRAIN_SPLIT = "train"
TRAIN_SAMPLES = 500
CHECKPOINT_PATH = "checkpoints/ablation_v4_8b/winogrande_topk50_policy.pt"
