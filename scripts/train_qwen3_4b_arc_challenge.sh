...
#SBATCH --job-name=train_qwen3_4b_arc_challenge
#SBATCH --output=logs/train_qwen3_4b_arc_challenge_%j.out
#SBATCH --error=logs/train_qwen3_4b_arc_challenge_%j.err

# Train reading policy: Qwen3-4B on arc_challenge
...
python3 run_rl_train.py \
    ...
    --max_grad_norm 1.0 \
    --seed 42 \
    --output_dir checkpoints/rl_policy/qwen3_4b_arc_challenge_$SLURM_JOB_ID
