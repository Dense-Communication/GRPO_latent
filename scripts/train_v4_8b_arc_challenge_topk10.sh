...
#SBATCH --job-name=train_8b_arc_challenge_k10
#SBATCH --output=logs/train_v4_8b_arc_challenge_topk10_%j.out
#SBATCH --error=logs/train_v4_8b_arc_challenge_topk10_%j.err
...
TRAIN_SPLIT = "train"
TRAIN_SAMPLES = 500
CHECKPOINT_PATH = "checkpoints/ablation_v4_8b/arc_challenge_topk10_policy.pt"
