...
#SBATCH --job-name=train_v4_winogrande_k20
#SBATCH --output=logs/train_v4_winogrande_topk20_%j.out
#SBATCH --error=logs/train_v4_winogrande_topk20_%j.err

# V4: Pure task optimization - find optimal accuracy-efficiency trade-off
# winogrande with top_k=20
...
TRAIN_SPLIT = "train"
TRAIN_SAMPLES = 500
CHECKPOINT_PATH = "checkpoints/ablation_v4/winogrande_topk20_policy.pt"
