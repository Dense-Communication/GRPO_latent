...
#SBATCH --job-name=train_8b_winogrande_k10
#SBATCH --output=logs/train_v4_8b_winogrande_topk10_%j.out
#SBATCH --error=logs/train_v4_8b_winogrande_topk10_%j.err
...
TRAIN_SPLIT = "train"
TRAIN_SAMPLES = 500
CHECKPOINT_PATH = "checkpoints/ablation_v4_8b/winogrande_topk10_policy.pt"
