...
#SBATCH --job-name=train_8b_arc_challenge_k50
#SBATCH --output=logs/train_v4_8b_arc_challenge_topk50_%j.out
#SBATCH --error=logs/train_v4_8b_arc_challenge_topk50_%j.err

# V4 8B: Qwen3-8B evaluation
# arc_challenge with top_k=50
...
TRAIN_SPLIT = "train"
TRAIN_SAMPLES = 500
CHECKPOINT_PATH = "checkpoints/ablation_v4_8b/arc_challenge_topk50_policy.pt"
