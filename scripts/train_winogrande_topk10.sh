...
#SBATCH --job-name=train_winogrande_k10
#SBATCH --output=logs/train_winogrande_topk10_%j.out
#SBATCH --error=logs/train_winogrande_topk10_%j.err
...
TRAIN_SPLIT = "train"
TRAIN_SAMPLES = 300
CHECKPOINT_PATH = "checkpoints/ablation/winogrande_topk10_policy.pt"
